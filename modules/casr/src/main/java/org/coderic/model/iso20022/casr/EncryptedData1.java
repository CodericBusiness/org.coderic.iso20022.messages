 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Ctrl" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Exact1HexBinaryText" minOccurs="0"/&gt;
 *         &lt;element name="KeySetIdr" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max8NumericText" minOccurs="0"/&gt;
 *         &lt;element name="DrvdInf" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max32HexBinaryText" minOccurs="0"/&gt;
 *         &lt;element name="Algo" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max2NumericText" minOccurs="0"/&gt;
 *         &lt;element name="KeyLngth" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max4NumericText" minOccurs="0"/&gt;
 *         &lt;element name="KeyPrtcn" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max2NumericText" minOccurs="0"/&gt;
 *         &lt;element name="KeyIndx" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max5NumericText" minOccurs="0"/&gt;
 *         &lt;element name="PddgMtd" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max2NumericText" minOccurs="0"/&gt;
 *         &lt;element name="NcrptdDataFrmt" type="{urn:iso:std:iso:20022:tech:xsd:casr.002.001.02}Max2NumericText" minOccurs="0"/&gt;
