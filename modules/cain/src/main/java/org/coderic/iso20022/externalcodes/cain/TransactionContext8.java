 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MrchntCtgyCd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}ISO18245MerchantCategoryCode" minOccurs="0"/&gt;
 *         &lt;element name="MrchntCtgySpcfcData" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}Max35Text" minOccurs="0"/&gt;
 *         &lt;element name="FeeColltnInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}FeeCollectionInitiator1Code" minOccurs="0"/&gt;
 *         &lt;element name="TxInitr" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TransactionInitiator1Code" minOccurs="0"/&gt;
 *         &lt;element name="PrtlShipmntInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="DelydChrgsInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="NoShowInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="ReauthstnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="ReSubmissnInd" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}TrueFalseIndicator" minOccurs="0"/&gt;
 *         &lt;element name="CardPrgrmmApld" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}CardProgrammeMode3" minOccurs="0"/&gt;
 *         &lt;element name="Jursdctn" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}Jurisdiction2" minOccurs="0"/&gt;
 *         &lt;element name="SttlmSvc" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}SettlementService4" minOccurs="0"/&gt;
 *         &lt;element name="Rcncltn" type="{urn:iso:std:iso:20022:tech:xsd:cain.028.001.02}Reconciliation3" minOccurs="0"/&gt;
