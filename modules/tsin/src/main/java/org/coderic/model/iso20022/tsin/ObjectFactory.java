...
// Generado el: 2024.03.15 a las 03:09:56 PM COT 
//


package org.coderic.model.iso20022.tsin;
 ...
 * generated in the org.coderic.model.iso20022.tsin package. 
...
public class ObjectFactory {
    ...
    private final static QName _Document_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "Document");
    private final static QName _FinancingNotificationParties1AckRcvr_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "AckRcvr");
    private final static QName _FinancingItemList1RltdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "RltdDoc");
    private final static QName _FinancialItemParameters1RltdItm_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "RltdItm");
    private final static QName _FinancialItemParameters1GovngCtrct_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "GovngCtrct");
    private final static QName _FinancialItem1FinDocRef_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "FinDocRef");
    private final static QName _FinancialItem1AssoctdDoc_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", "AssoctdDoc");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.coderic.model.iso20022.tsin
     * 
     */
    ...
    /**
     * Create an instance of {@link InvoiceAssignmentAcknowledgementV01 }
     * 
     */
    public InvoiceAssignmentAcknowledgementV01 createInvoiceAssignmentAcknowledgementV01() {
        return new InvoiceAssignmentAcknowledgementV01();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "Document")
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "AckRcvr", scope = FinancingNotificationParties1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancingNotificationParties1AckRcvr(Object value) {
        return new JAXBElement<Object>(_FinancingNotificationParties1AckRcvr_QNAME, Object.class, FinancingNotificationParties1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "RltdDoc", scope = FinancingItemList1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancingItemList1RltdDoc(Object value) {
        return new JAXBElement<Object>(_FinancingItemList1RltdDoc_QNAME, Object.class, FinancingItemList1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "RltdItm", scope = FinancialItemParameters1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancialItemParameters1RltdItm(Object value) {
        return new JAXBElement<Object>(_FinancialItemParameters1RltdItm_QNAME, Object.class, FinancialItemParameters1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "GovngCtrct", scope = FinancialItemParameters1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancialItemParameters1GovngCtrct(Object value) {
        return new JAXBElement<Object>(_FinancialItemParameters1GovngCtrct_QNAME, Object.class, FinancialItemParameters1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "FinDocRef", scope = FinancialItem1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancialItem1FinDocRef(Object value) {
        return new JAXBElement<Object>(_FinancialItem1FinDocRef_QNAME, Object.class, FinancialItem1 .class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Object }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:tsin.013.001.01", name = "AssoctdDoc", scope = FinancialItem1 .class)
    @XmlIDREF
    public JAXBElement<Object> createFinancialItem1AssoctdDoc(Object value) {
        return new JAXBElement<Object>(_FinancialItem1AssoctdDoc_QNAME, Object.class, FinancialItem1 .class, value);
    }
