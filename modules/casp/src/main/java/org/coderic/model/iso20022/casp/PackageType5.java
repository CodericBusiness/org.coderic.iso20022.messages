 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PackgId" type="{urn:iso:std:iso:20022:tech:xsd:casp.017.001.06}GenericIdentification176" minOccurs="0"/&gt;
 *         &lt;element name="PackgLngth" type="{urn:iso:std:iso:20022:tech:xsd:casp.017.001.06}PositiveNumber" minOccurs="0"/&gt;
 *         &lt;element name="OffsetStart" type="{urn:iso:std:iso:20022:tech:xsd:casp.017.001.06}PositiveNumber" minOccurs="0"/&gt;
 *         &lt;element name="OffsetEnd" type="{urn:iso:std:iso:20022:tech:xsd:casp.017.001.06}PositiveNumber" minOccurs="0"/&gt;
 *         &lt;element name="PackgBlck" type="{urn:iso:std:iso:20022:tech:xsd:casp.017.001.06}ExternallyDefinedData5" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
