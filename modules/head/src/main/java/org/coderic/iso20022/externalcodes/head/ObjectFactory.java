 ...
 * generated in the org.coderic.iso20022.externalcodes.head package. 
...
public class ObjectFactory {
    ...
    private final static QName _AppHdr_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:head.001.001.03", "AppHdr");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.coderic.iso20022.externalcodes.head
     * 
     */
    ...
    /**
     * Create an instance of {@link BusinessApplicationHeaderV03 }
     * 
     */
    public BusinessApplicationHeaderV03 createBusinessApplicationHeaderV03() {
        return new BusinessApplicationHeaderV03();
    }
    ...
    /**
     * Create an instance of {@link BusinessApplicationHeader7 }
     * 
     */
    public BusinessApplicationHeader7 createBusinessApplicationHeader7() {
        return new BusinessApplicationHeader7();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BusinessApplicationHeaderV03 }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link BusinessApplicationHeaderV03 }{@code >}
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:head.001.001.03", name = "AppHdr")
    public JAXBElement<BusinessApplicationHeaderV03> createAppHdr(BusinessApplicationHeaderV03 value) {
        return new JAXBElement<BusinessApplicationHeaderV03>(_AppHdr_QNAME, BusinessApplicationHeaderV03 .class, null, value);
    }
